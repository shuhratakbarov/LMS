...
import uz.farobiy.lms_clone.component.jwt.JwtService;
...
import uz.farobiy.lms_clone.db.customDto.admin.UserCustomDtoForAdmin;
import uz.farobiy.lms_clone.db.repository.admin.GroupRepository;
import uz.farobiy.lms_clone.db.repository.RoleRepository;
import uz.farobiy.lms_clone.db.repository.admin.UserRepository;
import uz.farobiy.lms_clone.dto.*;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public ResponseDto login(LoginForm form) throws Exception {
        try {
