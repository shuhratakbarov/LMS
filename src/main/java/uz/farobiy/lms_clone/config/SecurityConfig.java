package uz.farobiy.lms_clone.config;
...
import uz.farobiy.lms_clone.component.jwt.JwtAuthFilter;
...
public class SecurityConfig{
    ...
    @Autowired
    public SecurityConfig(JwtAuthFilter authFilter, AuthService authService) {
