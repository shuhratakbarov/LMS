...
import uz.farobiy.lesson_11_backend.db.domain.customDto.teacher.StudentCustomDtoForTeacher;
...
public interface TeacherRepository extends JpaRepository<Group, Long> {
    ...
    Page<Group> findAllByCourse_IdAndTeacher_Id(Long courseId, UUID userId, Pageable pageable);
