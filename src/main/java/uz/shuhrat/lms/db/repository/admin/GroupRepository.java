...
import uz.shuhrat.lms.projection.GroupAndStudentCountProjection;
import uz.shuhrat.lms.projection.GroupAndTeacherProjection;
...
public interface GroupRepository extends JpaRepository<Group, Long> {
    ...
    List<Group> findByStudentsContainsOrTeacher(User student, User teacher);
    ...
    List<GroupAndStudentCountProjection> getGroupsAndCountByTeacherId(@Param("id") UUID id);
    ...
    List<GroupAndTeacherProjection> getGroupsAndTeacherByStudentId(@Param("id") UUID id);
    ...
    List<GroupIdAndNameProjection> getGroupIdAndName();
